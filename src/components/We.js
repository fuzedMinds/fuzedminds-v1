...
const We = () => {
  return (
    <div className="bg-gray-100 pt-10 pb-10">
      <section>
        <div className="px-12 bg-white m-10 mt-0 p-2">
          <div className="flex flex-wrap justify-center p-3 font-sans">
            ...
            <div className="transition-all hover:bg-[#e5f1fb]  rounded-lg p-3 group w-[357px] m-3">
              ...
              <div>
                <p className="my-3 text-md font-normal">
                  We offer personalized consultation services for app
                  development and software projects. Whether you need guidance
                  on building an app or support in finding the right team
                  members, we’re here to make the process smooth and successful.
            ...
            <div className="transition-all hover:bg-[#e5f1fb]  rounded-lg p-3 group w-[357px] m-3">
              ...
              <div>
                <p className="my-3 text-md font-normal">
                  ...
                  new ideas, learning from challenges, and discovering
                  innovative solutions. By staying curious and embracing change,
                  we push boundaries and grow together. Every step forward is a
                  chance to create something meaningful and impactful, driven by
                  a passion for exploration and continuous improvement.
                </p>
              </div>
            </div>
          </div>
